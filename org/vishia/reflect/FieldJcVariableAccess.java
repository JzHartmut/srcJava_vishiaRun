...
public class FieldJcVariableAccess implements VariableAccessArray_ifc
{
  ...
  @Override public void requestValue(long timeRequested, Runnable run){ timeRequestRefresh = timeRequested; }
  ...
  @Override public boolean isRequestedValue(long timeEarlyRequested, boolean retryFaultyVariables){
    ...
    long timeReq = timeRequestRefresh - timeEarlyRequested;
    return (timeLastRefreshed == 0 || timeNew >=0) && timeReq >=0;
  }
