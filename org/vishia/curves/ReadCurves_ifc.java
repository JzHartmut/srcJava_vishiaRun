...
/**This interface can be used for reading curves from files from any application. Implementors are 'importer' for that data.
...
public interface ReadCurves_ifc
{
   ...
   */
  public static final String sVersion = "2014-08-25";
  ...
  void readCurveTimestamp(Timeshort timeshortabs);
   ...
   * @throws IOException
   */
  void readCurveStart(int timeshort) throws IOException ;
  
  void readCurveRecord(int timeshort, float[] values) throws IOException ;
  
  void readCurveFinish() throws IOException ;
  
  void readCurveError(String msg) throws IOException ;
